...
/** \brief Funcion que muestra un mensaje(menu), y retorna un entero(opcion elegida del menu)
 *
 * \param mensaje[] char
 * \return int X valor segun las opciones que demos
 *
 */
...
int getValidInt(char requestMessage[],char errorMessage[], int lowLimit, int hiLimit)
{
    ...
    while(1)
    {
        ...
        {
            printf ("El digito debe ser mayor a %d y menor a %d\n",lowLimit,hiLimit);
            continue;
